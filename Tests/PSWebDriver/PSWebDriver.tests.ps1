    ...
    try {
        ...
        Describe 'GetHttpStatusCode()' {
            It 'Return Http Status 404' {
                ...
                $Driver.GetHttpStatusCode('http://ozuma.sakura.ne.jp/httpstatus/404') | Should -BeExactly 404
            }

            It 'Return Http Status 200' {
                $Driver.GetHttpStatusCode('http://ozuma.sakura.ne.jp/httpstatus/200') | Should -BeExactly 200
            }
